        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-4">
                    <div class="product1 vip">
                        <div class="product4-image new"></div>
...
<%--                                    </svg><!-- <i class="fa-solid fa-earth-asia"></i> Font Awesome fontawesome.com -->--%>
                ...
                <div class="col-12 col-md-4">
                    <div class="product1 vip">
                        <div class="product6-image new"></div>
                        <div class="product1-conntent">
                            <div class="product1-conntent-header">
                                <a href="">Căn hộ chung cư tại Sky Park Residence</a>
                            </div>
...
<%--                                    </svg><!-- <i class="fa-solid fa-earth-asia"></i> Font Awesome fontawesome.com -->--%>
                ...
                <div class="col-12 col-md-4">
                    <div class="product1 vip">
                        <div class="product8-image new"></div>
...
<%--                                    </svg><!-- <i class="fa-solid fa-earth-asia"></i> Font Awesome fontawesome.com -->--%>
                ...
                <div class="col-12 col-md-4">
                    <div class="product1 vip">
                        <div class="product9-image new"></div>
...
<%--                                    </svg><!-- <i class="fa-solid fa-earth-asia"></i> Font Awesome fontawesome.com -->--%>
                ...
                <div class="col-12 col-md-4">
                    <div class="product1 vip">
                        <div class="product11-image new"></div>
