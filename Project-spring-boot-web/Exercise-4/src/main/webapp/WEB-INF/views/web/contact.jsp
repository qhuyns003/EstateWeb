    ...
    <div class="intro text-center mb-5">
        ...
        <div class="row">
            <div class="col-xs-12 a-left">
                <ul class="desc-intro">
                    <li class="home">
                        <a href="./ViewHome.html"><span style="color:indianred">Trang chủ</span></a>
                        <span class="mx-1" style="color:indianred"> / </span>
                    </li>
...
<%--                                    https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.577731862711!2d106.7695372142139!3d10.850261760047032!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752f8d0e993b05%3A0x8abf4c480f8b822b!2zOTcgTWFuIFRoacOqbiwgUGjDuiBIaeG7h3AgSMaw4budYywgbmjhuq10IHPDumMgVHJ1w6JuIFbEg25nLCBWaeG7h3QgTmFt!5e0!3m2!1sen!2s!4v1652520257601!5m2!1sen!2s--%>
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3371.1954845189525!2d105.7848415747131!3d20.98091798942111!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135accdd8a1ad71%3A0xa2f9b16036648187!2zSOG7jWMgdmnhu4duIEPDtG5nIG5naOG7hyBCxrB1IGNow61uaCB2aeG7hW4gdGjDtG5n!5e1!3m2!1svi!2s!4v1730392521427!5m2!1svi!2s"
    ...
    <div class="box-lienhe mt-5">
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6">
                    <h2 class="title-lienhe"><strong>Công ty cổ phần bất động sản J97 Land</strong></h2>
                    <div class="desc-lienhe">
                        <p>Được thành lập vào ngày 20/08/2008 với niềm đam mê và khát vọng thành công trong lĩnh vực
                            bất động sản. Nhờ chiến lược rõ ràng và hướng đi đúng, J97 Land đã nhanh chóng phát triển
                        ...
                        <ul class="margin-bottom-15 link" style="list-style-type: none;">
                            <li>
                                ...
                                <span class="title-li"> Hùng Vương-Ba Đình-Hà Nội</span>
                            </li>
                            <li>
                                <span class="block_fonticon"><i class="fa fa-mobile icon-lienhe"></i></span>
                                <span class="title-li">
                                        Hotline: <a style="color: indianred;" class="fone" href="">0922227</a>

                                    </span>
                            </li>
                            <li>
                                <span class="block_fonticon"><i class="fa fa-envelope icon-lienhe"></i></span>
                                <span class="title-li">Email: <a style="color: indianred;"
                ...
                <div class="col-12 col-md-6">
                    ...
                    <form id="contactWithUs" action="/api/customer" method="POST">
                        <div class="row">
                            <div class="col">
...
<script>
    $('#sendContact').click(function (e) {
        ...
        $.ajax({
            type: $('#contactWithUs').attr('method'), // Lấy phương thức (GET/POST) từ biểu mẫu
            url: $('#contactWithUs').attr('action'), // Lấy URL hành động từ biểu mẫu
            data: $('#contactWithUs').serialize(), // Chuyển đổi dữ liệu biểu mẫu thành chuỗi
